        ...
        <div className={`flex flex-col h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
            ...
            <main className="flex-1 overflow-y-auto p-6">
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-4xl font-semibold">Hello, {userData.name?userData.name : "User"} 👋</h1>
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div className={`rounded-lg p-4 ${darkMode ? 'bg-gray-800' : 'bg-blue-100'}`}>
                        <h2 className={`${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Registered Doctors With Donix</h2>
                        <p className="text-2xl font-bold">1,248</p>
                    </div>
                    {[
                        { label: 'Donations Made', value: 17 },
                        { label: 'Requests Responded To', value: 71 },                        
                    ].map((item, index) => (
                ...
                <div className={`p-6 rounded-lg shadow-lg mb-8 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4"> 
                        {[  
                            ...
                            { label: 'Approved Donations', value: 0 },
                            { label: 'Completed Donations', value: 71 },
                        ].map((item, index) => (
                ...
                <div className={`p-6 rounded-lg shadow-lg mb-8 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {[  
                            { label: 'Ongoing Transplants', value: 0 },
                            { label: 'Completed Transplants', value: 0 },
                        ].map((item, index) => (
                            <div key={index} className={`rounded-lg p-4 ${darkMode ? 'bg-gray-700' : 'bg-blue-100'}`}>
                                <h2 className={`${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>{item.label}</h2>
                                <p className="text-2xl font-bold">{item.value}</p>
